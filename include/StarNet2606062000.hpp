...
class StarNet2606062000Options {
private:
    int in_channels = 128;
...
public:
    ...
    StarNet2606062000Options(void) {
        update();
        return;
    }

    int Depth(int stage);
    StarNet2606062000Options& setInChannels(int value);
    StarNet2606062000Options& setCompressedChannels(int value);
    StarNet2606062000Options& setEmbed(int value);
    StarNet2606062000Options& setConvKs(int value);
    StarNet2606062000Options& setConvStride(int value);
    StarNet2606062000Options& setDropRate(double value);
    StarNet2606062000Options& setNumClasses(int value);
    StarNet2606062000Options& setDepths(std::vector<int> value);

};

class StarNet2606062000Impl : public torch::nn::Module {
private:
    // Stem
...
public:
    StarNet2606062000Impl(StarNet2606062000Options model_config);
    torch::Tensor forward(torch::Tensor x);
};
TORCH_MODULE(StarNet2606062000);