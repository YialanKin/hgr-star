...
class StarNet2605071620Options {
private:
    int in_channels = 128;
...
public:
    ...
    StarNet2605071620Options(void) {
        update();
        return;
    }

    int Depth(int stage);
    StarNet2605071620Options& setInChannels(int value);
    StarNet2605071620Options& setCompressedChannels(int value);
    StarNet2605071620Options& setEmbed(int value);
    StarNet2605071620Options& setConvKs(int value);
    StarNet2605071620Options& setConvStride(int value);
    StarNet2605071620Options& setDropRate(double value);
    StarNet2605071620Options& setNumClasses(int value);
    StarNet2605071620Options& setDepths(std::vector<int> value);

};

class StarNet2605071620Impl : public torch::nn::Module {
private:
    // Stem
...
public:
    StarNet2605071620Impl(StarNet2605071620Options model_config);
    torch::Tensor forward(torch::Tensor x);
};
TORCH_MODULE(StarNet2605071620);