...
public:
    ...
    StarNet2510152000Options& setDropRate(double value);
    StarNet2510152000Options& setNumClasses(int value);
    StarNet2510152000Options& setDepths(std::vector<int> value);

};

class StarNet2510152000Impl : public torch::nn::Module {
private:
    // Stem
...
public:
    StarNet2510152000Impl(StarNet2510152000Options model_config);
    torch::Tensor forward(torch::Tensor x);
};
TORCH_MODULE(StarNet2510152000);