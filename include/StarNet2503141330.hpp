...
class StarNet2503141330Options {
private:
    int in_channels = 512;
...
public:
    torch::nn::UpsampleOptions pre_upsample_config = torch::nn::UpsampleOptions().size(std::vector<int64_t>({32, 32})).mode(torch::kBilinear).align_corners(false);
    torch::nn::Conv2dOptions pre_dechannel_config = torch::nn::Conv2dOptions(512, 24, 1);
    ...
    StarNet2503141330Options(void) {
        update();
        return;
    }

    int Depth(int stage);
    StarNet2503141330Options& setInChannels(int value);
    StarNet2503141330Options& setUpsampleSize(int value);
    StarNet2503141330Options& setDechannels(int value);
    StarNet2503141330Options& setEmbed(int value);
    StarNet2503141330Options& setConvKs(int value);
    StarNet2503141330Options& setConvStride(int value);
    StarNet2503141330Options& setDropRate(double value);
    StarNet2503141330Options& setNumClasses(int value);
    StarNet2503141330Options& setDepths(std::vector<int> value);

};

class StarNet2503141330Impl : public torch::nn::Module {
private:
    // Stem
...
public:
    StarNet2503141330Impl(StarNet2503141330Options model_config);
    torch::Tensor forward(torch::Tensor x);
};
TORCH_MODULE(StarNet2503141330);