/**
 * @file MultiFeatureDataset.cpp
 * @brief 包含 MultiFeatureDataset 类、配置结构体及构建器类的实现。
 * @author Rat Kin
 * @date 2025-03-02
 * 
...
MultiFeatureDataset::MultiFeatureDataset(const MultiFeatureDatasetConfig& config) {
    // 初始化原始特征的文件列表
...
torch::optional<size_t> MultiFeatureDataset::size() const {
...
torch::data::Example<> MultiFeatureDataset::get(size_t index) {
    // 读取原始特征的二进制文件
...
MultiFeatureDatasetBuilder& MultiFeatureDatasetBuilder::addPath_Orig(std::string value) {
    config.paths_orig.push_back(value);
    return *this;
}

MultiFeatureDatasetBuilder& MultiFeatureDatasetBuilder::addPath_Enve(std::string value) {
    config.paths_enve.push_back(value);
    return *this;
}

MultiFeatureDatasetBuilder& MultiFeatureDatasetBuilder::addPath_MUAPP2P(std::string value) {
    config.paths_muapp2p.push_back(value);
    return *this;
}

MultiFeatureDatasetBuilder& MultiFeatureDatasetBuilder::addPath_Comm(std::string value) {
    config.paths_comm.push_back(value);
    return *this;
}

MultiFeatureDatasetBuilder& MultiFeatureDatasetBuilder::clearPaths(void) {
...
MultiFeatureDatasetBuilder& MultiFeatureDatasetBuilder::setNChannels_Orig(int value) {
    config.nchannels_orig = value;
    return *this;
}

MultiFeatureDatasetBuilder& MultiFeatureDatasetBuilder::setDepth_Orig(int value) {
    config.depth_orig = value;
    return *this;
}

MultiFeatureDatasetBuilder& MultiFeatureDatasetBuilder::setHeight_Orig(int value) {
    config.height_orig = value;
    return *this;
}

MultiFeatureDatasetBuilder& MultiFeatureDatasetBuilder::setWidth_Orig(int value) {
    config.width_orig = value;
    return *this;
}

MultiFeatureDatasetBuilder& MultiFeatureDatasetBuilder::setNChannels_Enve(int value) {
    config.nchannels_enve = value;
    return *this;
}

MultiFeatureDatasetBuilder& MultiFeatureDatasetBuilder::setDepth_Enve(int value) {
    config.depth_enve = value;
    return *this;
}

MultiFeatureDatasetBuilder& MultiFeatureDatasetBuilder::setHeight_Enve(int value) {
    config.height_enve = value;
    return *this;
}

MultiFeatureDatasetBuilder& MultiFeatureDatasetBuilder::setWidth_Enve(int value) {
    config.width_enve = value;
    return *this;
}

MultiFeatureDatasetBuilder& MultiFeatureDatasetBuilder::setNChannels_MUAPP2P(int value) {
    config.nchannels_muapp2p = value;
    return *this;
}

MultiFeatureDatasetBuilder& MultiFeatureDatasetBuilder::setDepth_MUAPP2P(int value) {
    config.depth_muapp2p = value;
    return *this;
}

MultiFeatureDatasetBuilder& MultiFeatureDatasetBuilder::setHeight_MUAPP2P(int value) {
    config.height_muapp2p = value;
    return *this;
}

MultiFeatureDatasetBuilder& MultiFeatureDatasetBuilder::setWidth_MUAPP2P(int value) {
    config.width_muapp2p = value;
    return *this;
}

MultiFeatureDatasetBuilder& MultiFeatureDatasetBuilder::setNChannels_Comm(int value) {
    config.nchannels_comm = value;
    return *this;
}

MultiFeatureDatasetBuilder& MultiFeatureDatasetBuilder::setDepth_Comm(int value) {
    config.depth_comm = value;
    return *this;
}

MultiFeatureDatasetBuilder& MultiFeatureDatasetBuilder::setHeight_Comm(int value) {
    config.height_comm = value;
    return *this;
}

MultiFeatureDatasetBuilder& MultiFeatureDatasetBuilder::setWidth_Comm(int value) {
    config.width_comm = value;
    return *this;
}

std::shared_ptr<MultiFeatureDataset> MultiFeatureDatasetBuilder::build(void) {
    return std::make_shared<MultiFeatureDataset>(config);
}