...
StarNet2606062000Impl::StarNet2606062000Impl(StarNet2606062000Options model_config) {
...
torch::Tensor StarNet2606062000Impl::forward(torch::Tensor x) {
    int b = x.size(0);
    int c = x.size(1);
    int d = x.size(2);
    int h = x.size(3);
...
void StarNet2606062000Options::update(void) {
...
int StarNet2606062000Options::Depth(int stage) {
    return depths[stage - 1];
}

StarNet2606062000Options& StarNet2606062000Options::setInChannels(int value) {
    in_channels = value;
    update();
    return *this;
}

StarNet2606062000Options& StarNet2606062000Options::setCompressedChannels(int value) {
    compressed_channels = value;
    update();
    return *this;
}

StarNet2606062000Options& StarNet2606062000Options::setEmbed(int value) {
    embed = value;
    update();
    return *this;
}

StarNet2606062000Options& StarNet2606062000Options::setConvKs(int value) {
    conv_ks = value;
    update();
    return *this;
}

StarNet2606062000Options& StarNet2606062000Options::setConvStride(int value) {
    conv_stride = value;
    update();
    return *this;
}

StarNet2606062000Options& StarNet2606062000Options::setDropRate(double value) {
    drop_rate = value;
    update();
    return *this;
}

StarNet2606062000Options& StarNet2606062000Options::setNumClasses(int value) {
    num_classes = value;
    update();
    return *this;
}

StarNet2606062000Options& StarNet2606062000Options::setDepths(std::vector<int> value) {
    depths = value;
    update();
    return *this;
}