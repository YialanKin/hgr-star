...
StarNet2510161140Impl::StarNet2510161140Impl(StarNet2510161140Options model_config) {
...
torch::Tensor StarNet2510161140Impl::forward(torch::Tensor x) {
    int b = x.size(0);
    int c = x.size(1);
    int d = x.size(2);
    int h = x.size(3);
...
void StarNet2510161140Options::update(void) {
...
int StarNet2510161140Options::Depth(int stage) {
    return depths[stage - 1];
}

StarNet2510161140Options& StarNet2510161140Options::setInChannels(int value) {
    in_channels = value;
    update();
    return *this;
}

StarNet2510161140Options& StarNet2510161140Options::setEmbed(int value) {
    embed = value;
    update();
    return *this;
}

StarNet2510161140Options& StarNet2510161140Options::setConvKs(int value) {
    conv_ks = value;
    update();
    return *this;
}

StarNet2510161140Options& StarNet2510161140Options::setConvStride(int value) {
    conv_stride = value;
    update();
    return *this;
}

StarNet2510161140Options& StarNet2510161140Options::setDropRate(double value) {
    drop_rate = value;
    update();
    return *this;
}

StarNet2510161140Options& StarNet2510161140Options::setNumClasses(int value) {
    num_classes = value;
    update();
    return *this;
}

StarNet2510161140Options& StarNet2510161140Options::setDepths(std::vector<int> value) {
    depths = value;
    update();
    return *this;
}