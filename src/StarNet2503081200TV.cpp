...
StarNet2503081200TV::StarNet2503081200TV(const StarNet2503081200TVConfig& config) {
...
std::pair<double, double> StarNet2503081200TV::trainOneEpoch(int epoch) {
    // 计时
...
std::pair<double, double> StarNet2503081200TV::evaluate(int epoch) {
    // 计时
    auto epoch_start_time = std::chrono::system_clock::now();               // 该轮次的开始时间
    int64_t batch_duration_sum = 0;                                         // 所有循环的总耗时
    int64_t batch_duration_ave = 0;                                         // 循环的平均用时
...
int64_t StarNet2503081200TV::computeDuration_ms(const std::chrono::system_clock::time_point& start, const std::chrono::system_clock::time_point& end) {
    auto duration = end - start;
    auto milliseconds = std::chrono::duration_cast<std::chrono::milliseconds>(duration).count();
    return milliseconds;
}

std::vector<int64_t> StarNet2503081200TV::computeDuration_hms(const std::chrono::system_clock::time_point& start, const std::chrono::system_clock::time_point& end) {
    auto duration = end - start;
...
StarNet2503081200TVBuilder& StarNet2503081200TVBuilder::setCUDA(bool value) {
...
StarNet2503081200TVBuilder& StarNet2503081200TVBuilder::setEpochs(int value) {
    config.epochs = value;
    return *this;
}

StarNet2503081200TVBuilder& StarNet2503081200TVBuilder::setWarmup(int value) {
    config.warmup = value;
    return *this;
}

StarNet2503081200TVBuilder& StarNet2503081200TVBuilder::setBatchSize(int value) {
    config.batch_size = value;
    return *this;
}

StarNet2503081200TVBuilder& StarNet2503081200TVBuilder::setLearningRate(double value) {
    config.learning_rate = value;
    return *this;
}

StarNet2503081200TVBuilder& StarNet2503081200TVBuilder::setBeta1(double value) {
    config.beta1 = value;
    return *this;
}

StarNet2503081200TVBuilder& StarNet2503081200TVBuilder::setBeta2(double value) {
    config.beta2 = value;
    return *this;
}

StarNet2503081200TVBuilder& StarNet2503081200TVBuilder::setWeightDecay(double value) {
    config.weight_decay = value;
    return *this;
}

StarNet2503081200TVBuilder& StarNet2503081200TVBuilder::setRootOrig(std::string value) {
    config.root_orig = value;
    return *this;
}

StarNet2503081200TVBuilder& StarNet2503081200TVBuilder::setRootEnve(std::string value) {
    config.root_enve = value;
    return *this;
}

StarNet2503081200TVBuilder& StarNet2503081200TVBuilder::setRootMUAPP2P(std::string value) {
    config.root_muapp2p = value;
    return *this;
}

StarNet2503081200TVBuilder& StarNet2503081200TVBuilder::setRootComm(std::string value) {
    config.root_comm = value;
    return *this;
}

StarNet2503081200TVBuilder& StarNet2503081200TVBuilder::setSavePath(std::string value) {
    config.save_path = value;
    return *this;
}

StarNet2503081200TVBuilder& StarNet2503081200TVBuilder::setValFold(int value) {
    config.val_fold = value;
    return *this;
}

StarNet2503081200TVBuilder& StarNet2503081200TVBuilder::setCombination(int value) {
    config.combination = value;
    return *this;
}

std::shared_ptr<StarNet2503081200TV> StarNet2503081200TVBuilder::build(void) {
    return std::make_shared<StarNet2503081200TV>(config);
}
