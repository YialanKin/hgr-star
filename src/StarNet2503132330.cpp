#include "StarNet2503132330.hpp"

StarNet2503132330Impl::StarNet2503132330Impl(StarNet2503132330Options model_config) {
    pre_upsample = register_module("PreUpsample", torch::nn::Upsample(model_config.pre_upsample_config));
    pre_dechannel = register_module("PreDeChannel", torch::nn::Conv2d(model_config.pre_dechannel_config));
...
torch::Tensor StarNet2503132330Impl::forward(torch::Tensor x) {
    int b = x.size(0);
    int c = x.size(1);
    int d = x.size(2);
    int h = x.size(3);
    ...
    x = pre_upsample->forward(x);
    x = pre_dechannel->forward(x);
...
void StarNet2503132330Options::update(void) {
    pre_upsample_config = torch::nn::UpsampleOptions().size(std::vector<int64_t>({upsample_size, upsample_size})).mode(torch::kBilinear).align_corners(false);
    pre_dechannel_config = torch::nn::Conv2dOptions(in_channels, dechannels, 1);
    pre_conv_config = torch::nn::Conv2dOptions(dechannels, embed, conv_ks).stride(downsample_ratio).padding(1);
...
int StarNet2503132330Options::Depth(int stage) {
    return depths[stage - 1];
}

StarNet2503132330Options& StarNet2503132330Options::setInChannels(int value) {
    in_channels = value;
    update();
    return *this;
}

StarNet2503132330Options& StarNet2503132330Options::setUpsampleSize(int value) {
    upsample_size = value;
    update();
    return *this;
}

StarNet2503132330Options& StarNet2503132330Options::setDechannels(int value) {
    dechannels = value;
    update();
    return *this;
}

StarNet2503132330Options& StarNet2503132330Options::setDownsampleRatio(int value) {
    downsample_ratio = value;
    update();
    return *this;
}

StarNet2503132330Options& StarNet2503132330Options::setEmbed(int value) {
    embed = value;
    update();
    return *this;
}

StarNet2503132330Options& StarNet2503132330Options::setConvKs(int value) {
    conv_ks = value;
    update();
    return *this;
}

StarNet2503132330Options& StarNet2503132330Options::setConvStride(int value) {
    conv_stride = value;
    update();
    return *this;
}

StarNet2503132330Options& StarNet2503132330Options::setDropRate(double value) {
    drop_rate = value;
    update();
    return *this;
}

StarNet2503132330Options& StarNet2503132330Options::setNumClasses(int value) {
    num_classes = value;
    update();
    return *this;
}

StarNet2503132330Options& StarNet2503132330Options::setDepths(std::vector<int> value) {
    depths = value;
    update();
    return *this;
}