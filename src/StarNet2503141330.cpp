#include "StarNet2503141330.hpp"

StarNet2503141330Impl::StarNet2503141330Impl(StarNet2503141330Options model_config) {
...
torch::Tensor StarNet2503141330Impl::forward(torch::Tensor x) {
    int b = x.size(0);
    int c = x.size(1);
    int d = x.size(2);
    int h = x.size(3);
...
void StarNet2503141330Options::update(void) {
...
int StarNet2503141330Options::Depth(int stage) {
    return depths[stage - 1];
}

StarNet2503141330Options& StarNet2503141330Options::setInChannels(int value) {
    in_channels = value;
    update();
    return *this;
}

StarNet2503141330Options& StarNet2503141330Options::setUpsampleSize(int value) {
    upsample_size = value;
    update();
    return *this;
}

StarNet2503141330Options& StarNet2503141330Options::setDechannels(int value) {
    dechannels = value;
    update();
    return *this;
}

StarNet2503141330Options& StarNet2503141330Options::setEmbed(int value) {
    embed = value;
    update();
    return *this;
}

StarNet2503141330Options& StarNet2503141330Options::setConvKs(int value) {
    conv_ks = value;
    update();
    return *this;
}

StarNet2503141330Options& StarNet2503141330Options::setConvStride(int value) {
    conv_stride = value;
    update();
    return *this;
}

StarNet2503141330Options& StarNet2503141330Options::setDropRate(double value) {
    drop_rate = value;
    update();
    return *this;
}

StarNet2503141330Options& StarNet2503141330Options::setNumClasses(int value) {
    num_classes = value;
    update();
    return *this;
}

StarNet2503141330Options& StarNet2503141330Options::setDepths(std::vector<int> value) {
    depths = value;
    update();
    return *this;
}