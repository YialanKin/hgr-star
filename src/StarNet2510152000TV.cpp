...
StarNet2510152000TV::StarNet2510152000TV(const StarNet2510152000TVConfig& config) {
    ...
    model = std::make_shared<StarNet2510152000Impl>(config.model_config);
...
std::pair<double, double> StarNet2510152000TV::trainOneEpoch(int epoch) {
    // 计时
...
std::pair<double, double> StarNet2510152000TV::evaluate(int epoch) {
    // 计时
    auto epoch_start_time = std::chrono::system_clock::now();               // 该轮次的开始时间
    int64_t batch_duration_sum = 0;                                         // 所有循环的总耗时
    int64_t batch_duration_ave = 0;                                         // 循环的平均用时
...
int64_t StarNet2510152000TV::computeDuration_ms(const std::chrono::system_clock::time_point& start, const std::chrono::system_clock::time_point& end) {
    auto duration = end - start;
    auto milliseconds = std::chrono::duration_cast<std::chrono::milliseconds>(duration).count();
    return milliseconds;
}

std::vector<int64_t> StarNet2510152000TV::computeDuration_hms(const std::chrono::system_clock::time_point& start, const std::chrono::system_clock::time_point& end) {
    auto duration = end - start;
...
StarNet2510152000TVBuilder& StarNet2510152000TVBuilder::setCUDA(bool value) {
...
StarNet2510152000TVBuilder& StarNet2510152000TVBuilder::setEpochs(int value) {
    config.epochs = value;
    return *this;
}

StarNet2510152000TVBuilder& StarNet2510152000TVBuilder::setWarmup(int value) {
    config.warmup = value;
    return *this;
}

StarNet2510152000TVBuilder& StarNet2510152000TVBuilder::setBatchSize(int value) {
    config.batch_size = value;
    return *this;
}

StarNet2510152000TVBuilder& StarNet2510152000TVBuilder::setLearningRate(double value) {
    config.learning_rate = value;
    return *this;
}

StarNet2510152000TVBuilder& StarNet2510152000TVBuilder::setBeta1(double value) {
    config.beta1 = value;
    return *this;
}

StarNet2510152000TVBuilder& StarNet2510152000TVBuilder::setBeta2(double value) {
    config.beta2 = value;
    return *this;
}

StarNet2510152000TVBuilder& StarNet2510152000TVBuilder::setWeightDecay(double value) {
    config.weight_decay = value;
    return *this;
}

StarNet2510152000TVBuilder& StarNet2510152000TVBuilder::setRootOrig(std::string value) {
    config.root_orig = value;
    return *this;
}

StarNet2510152000TVBuilder& StarNet2510152000TVBuilder::setRootEnve(std::string value) {
    config.root_enve = value;
    return *this;
}

StarNet2510152000TVBuilder& StarNet2510152000TVBuilder::setRootMUAPP2P(std::string value) {
    config.root_muapp2p = value;
    return *this;
}

StarNet2510152000TVBuilder& StarNet2510152000TVBuilder::setRootComm(std::string value) {
    config.root_comm = value;
    return *this;
}

StarNet2510152000TVBuilder& StarNet2510152000TVBuilder::setSavePath(std::string value) {
    config.save_path = value;
    return *this;
}

StarNet2510152000TVBuilder& StarNet2510152000TVBuilder::setValFold(int value) {
    config.val_fold = value;
    return *this;
}

StarNet2510152000TVBuilder& StarNet2510152000TVBuilder::setCombination(int value) {
    config.combination = value;
    return *this;
}

std::shared_ptr<StarNet2510152000TV> StarNet2510152000TVBuilder::build(void) {
    return std::make_shared<StarNet2510152000TV>(config);
}
